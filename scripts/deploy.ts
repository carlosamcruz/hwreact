...
import { Helloworld02 } from '../src/contracts/helloworld02'
...
async function main() {
    ...
    const instance = new Helloworld02(
    ...
    console.log('Helloworld02 contract was successfully deployed!')
